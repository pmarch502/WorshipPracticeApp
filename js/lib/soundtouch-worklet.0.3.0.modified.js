...
var SoundTouchWorklet = function (_AudioWorkletProcesso) {
  function SoundTouchWorklet() {
    ...
    // MODIFIED: Override the hardcoded 44100 default with the actual AudioWorklet
    // sampleRate. Without this, systems running at 48000 Hz (or other rates) will
    // have slightly incorrect overlap/sequence/seek window calculations.
